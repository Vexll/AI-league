...
Usage
Set your OpenAI API key as an environment variable, or modify the code to include it.

Optionally, add JSON datasets to the datasets folder to enhance chatbot responses.
